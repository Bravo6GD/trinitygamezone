<html>
<head>
    <title>Trinity | SIGNUP</title>
    <link href="{{asset('css/home.css')}}" rel="stylesheet">
</head>
<body >
<h1>Trinity Gamezone Signup</h1>
<form method="post" action="{{action([\App\Http\Controllers\PagesController::class,'register'])}}" enctype="multipart/form-data">
    @csrf
